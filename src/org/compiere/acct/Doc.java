...
public abstract class Doc
{
	...
	//Begin faaguilar OFB AP Boleta a Proveedores Especial
	public static final String	DOCTYPE_AP_Boleta	= "APB";
	//begin faaguilar OFB Check Protested
	public static final String	DOCTYPE_PTCheck	= "PTK";
	//Begin faaguilar OFB AP Boleta Normal
	public static final String	DOCTYPE_AR_Boleta	= "ARB";
	//Begin faaguilar OFB client document change
	public static final String	DOCTYPE_AR_CDC	= "CDC";
	//Begin faaguilar OFB Vendor document change
	public static final String	DOCTYPE_AP_VDC	= "VDC";
	//Begin faaguilar OFB factoring
	public static final String	DOCTYPE_AR_FAT	= "FAT";
	//Begin faaguilar OFB Factura Servicios
	public static final String	DOCTYPE_API_Service	= "APS";
	//Begin faaguilar OFB NOTA CREDITO Servicios
	public static final String	DOCTYPE_PSC_Service	= "PSC";
	//Begin faaguilar OFB Factura Compromisos Adquiridos
	public static final String	DOCTYPE_API_Compromise= "APA";
	//faaguilar OFB AP leasing
	public static final String DOCTYPE_APLeasing = "APL";
	//ininoles OFB DM Document Resolucion de Asignacion
	public static final String DOCTYPE_DMResolution = "DMR";
	//ininoles OFB Solicitud de Pago
	public static final String DOCTYPE_PaymentRequest= "PRT";
	//ininoles OFB Boleta de Garantia aguas 
	public static final String DOCTYPE_AltaBoleta= "PBA";
	public static final String DOCTYPE_BajaVisadaBoleta= "PBB";
	public static final String DOCTYPE_CobroBoleta= "PBC";
	public static final String DOCTYPE_VencimientoBoleta= "PBV";
	...
	public static Doc get (MAcctSchema[] ass, int AD_Table_ID, ResultSet rs, String trxName) throws AdempiereUserError
	{
		...
		if(!className.contains("_DocType"))
		{
	...
	private final String postLogic (int index)
	{
		...
		//  rejectUnbalanced
		if (!m_ass[index].isSuspenseBalancing())
	...
	// Begin faaguilar OFB - Boletas de Proveedor
	public static final int 	ACCTTYPE_APB   = 5;
	// Begin faaguilar OFB - Check Protested
	public static final int 	ACCTTYPE_PTCheck   = 6;
	// Begin faaguilar OFB - Letra Protested
	public static final int 	ACCTTYPE_PTLetra   = 7;
	// Begin faaguilar OFB - Boletas de Venta
	public static final int 	ACCTTYPE_ARB   = 8;
	// Begin faaguilar OFB - client document change
	public static final int 	ACCTTYPE_CDC   = 300;
	// Begin faaguilar OFB - vendor document change
	public static final int 	ACCTTYPE_VDC   = 301;
	// Begin faaguilar OFB - factoring
	public static final int 	ACCTTYPE_FAT   = 302;
	// Begin faaguilar OFB - compromisos
	public static final int 	ACCTTYPE_APA   = 303;
	//ap leasing faaguilar OFB
	public static final int ACCTTYPE_V_Leasing = 304;
	// Begin faaguilar OFB - compromisos
	public static final int 	ACCTTYPE_APALargo   = 305;
	// Begin faaguilar OFB - compromisos
	public static final int 	ACCTTYPE_APACorto   = 306;
	...
	//faaguilar OFB cuentas de banco y pago begin
	public static final int     ACCTTYPE_CheckInTransit  = 15;
	public static final int     ACCTTYPE_LetrasInTransit  = 16;
	public static final int     ACCTTYPE_CheckToPay  = 17;
	public static final int     ACCTTYPE_LetrasToPay  = 18;
	public static final int     ACCTTYPE_VistaInTransit  = 19;
	public static final int     ACCTTYPE_VistaToPay  = 200;
	public static final int     ACCTTYPE_PagareInTransit  = 201;
	public static final int     ACCTTYPE_PagareToPay  = 202;	
	public static final int     ACCTTYPE_ExchangeToPay  = 203;
	public static final int     ACCTTYPE_ExchangeInTransit  = 204;
	public static final int     ACCTTYPE_PersonalVoucherToPay  = 205;
	public static final int     ACCTTYPE_PersonalVoucherInTransit  = 206;
	//faaguilar OFB cuentas de banco y pago end / se agregan 2 para windsor canje y vale personal (203/204)
	...
	// faaguilar OFB Import Purchase Order	
	public static final int     ACCTTYPE_POI = 113;
	//ininoles OFB DM Resolution subtitulo33 FRIL
	public static final int     ACCTTYPE_PJDefaulDMR = 206;
	//ininoles OFB Intermediacion de fondos - pago gore
	public static final int     ACCTTYPE_PIntermediation = 207;
	//ininoles OFB Retencion honorarios - pago gore
	public static final int     ACCTTYPE_RetentionH = 208;
	//ininoles OFB Cuentas Boleta de Garantia aguas
	public static final int     ACCTTYPE_AltaBoletaD = 209;
	public static final int     ACCTTYPE_AltaBoletaC = 210;
	public static final int     ACCTTYPE_BajaBoletaD = 211;
	public static final int     ACCTTYPE_BajaBoletaC = 212;
	public static final int     ACCTTYPE_CobroBoletaD = 213;
	public static final int     ACCTTYPE_CobroBoletaC = 214;
	public static final int     ACCTTYPE_VencimientoBoletaD = 215;
	public static final int     ACCTTYPE_VencimientoBoletaC = 216;
	//ininoles nuevas cuentas proceso factoring
	public static final int     ACCTTYPE_FactoringD = 217;
	public static final int     ACCTTYPE_FactoringC = 218;	
	//ininoles cuenta impuesto especifico PA
	public static final int     ACCTTYPE_ImpuestoEspecificoCombustible = 219;
	...
	public int getValidCombination_ID (int AcctType, MAcctSchema as)
	{
		...
		/**faaguilar OFB campos contables especificos */
		else if (AcctType == ACCTTYPE_APB)//faaguilar OFB Boletas de Vendor
		{
			sql = "SELECT C_APB_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}//END faaguilar OFB Boletas de Vendor
		else if (AcctType == ACCTTYPE_ARB)//faaguilar OFB Boletas de Venta
		{
			sql = "SELECT C_ARB_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}//END faaguilar OFB Boletas de Venta
		else if (AcctType == ACCTTYPE_PTCheck)//faaguilar OFB protested client check
		{
			sql = "SELECT C_CheckProtested_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}//END faaguilar OFB protested client check
		else if (AcctType == ACCTTYPE_PTLetra)//faaguilar OFB protested client letra
		{
			sql = "SELECT C_LetraProtested_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }//ENd faaguilar OFB protested client letra
        else if (AcctType == ACCTTYPE_CDC)// faaguilar OFB Customer Document Change
		{
			sql = "SELECT C_DocumentChangeC_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }//END faaguilar OFB Customer Document Change
        else if (AcctType == ACCTTYPE_VDC)//faaguilar OFB Vendor Document Change
		{
			sql = "SELECT C_DocumentChangeV_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }//END faaguilar OFB Vendor Document Change
        else if (AcctType == ACCTTYPE_FAT)//faaguilar OFB factoring
		{
			sql = "SELECT C_Factoring_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }
        else if (AcctType == ACCTTYPE_APA)//faaguilar OFB compromisos
		{
			sql = "SELECT C_CompAdq_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }
        else if (AcctType == ACCTTYPE_APALargo)//faaguilar OFB compromisos Largo
		{
			sql = "SELECT C_CompAdqLargo_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }
        else if (AcctType == ACCTTYPE_APACorto)//faaguilar OFB compromisos Corto
		{
			sql = "SELECT C_CompAdqCorto_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }
        else if (AcctType == ACCTTYPE_CheckInTransit) //custom K-L faaguilar OFB
		{
			sql = "SELECT B_CheckInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_LetrasInTransit)
		{
			sql = "SELECT B_LetrasInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_CheckToPay)
		{
			sql = "SELECT B_CheckToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_LetrasToPay)
		{
			sql = "SELECT B_LetrasToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_VistaInTransit)
		{
			sql = "SELECT B_VistaInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_VistaToPay)
		{
			sql = "SELECT B_VistaToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_PagareInTransit)
		{
			sql = "SELECT B_PagareInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_PagareToPay)
		{
			sql = "SELECT B_PagareToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_POI)//faaguilar OFB PO Import
		{
			sql = "SELECT POI_Acct FROM C_AcctSchema_GL WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}//END faaguilar OFB PO Import
		else if (AcctType == ACCTTYPE_POI)//faaguilar Material Receipt Import
		{
			sql = "SELECT POI_Acct FROM C_AcctSchema_GL WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_V_Leasing)//faaguilar OFB leasing
        {
        	sql = "SELECT C_Leasing_Acct FROM C_BP_Vendor_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
        }					
		//faaguilar OFB campos contables especificos end
		else if (AcctType == ACCTTYPE_PIntermediation)//ininoles intermediacion de fondos
		{
			sql = "SELECT C_Intermediation_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_RetentionH)//ininoles retencion honorarios
		{
			sql = "SELECT C_RetentionH_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_ExchangeToPay)//ininoles canje
		{
			sql = "SELECT B_ExchangeToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		} 
		else if (AcctType == ACCTTYPE_ExchangeInTransit)//ininoles canje
		{
			sql = "SELECT B_ExchangeInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_PersonalVoucherToPay)//ininoles vale personal
		{
			sql = "SELECT B_PersonalVoucherToPay_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_PersonalVoucherInTransit)//ininoles vale personal
		{
			sql = "SELECT B_PVoucherInTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_AltaBoletaD)//ininoles boletas aguas
		{
			sql = "SELECT DM_Alta_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_AltaBoletaC)//ininoles boletas aguas
		{
			sql = "SELECT DM_AltaCr_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}else if (AcctType == ACCTTYPE_BajaBoletaD)//ininoles boletas aguas
		{
			sql = "SELECT DM_BajaVisada_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_BajaBoletaC)//ininoles boletas aguas
		{
			sql = "SELECT DM_BajaVisadaCr_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_CobroBoletaD)//ininoles boletas aguas
		{
			sql = "SELECT DM_CobroDr_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;		
		}
		else if (AcctType == ACCTTYPE_CobroBoletaC)//ininoles boletas aguas
		{
			sql = "SELECT DM_CobroCr_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}	
		else if (AcctType == ACCTTYPE_VencimientoBoletaD)//ininoles boletas aguas
		{
			sql = "SELECT DM_BajaVencido_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_VencimientoBoletaC)//ininoles boletas aguas
		{
			sql = "SELECT DM_BajaVencidoCr_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_FactoringD)//ininoles boletas aguas
		{
			sql = "SELECT FactoringD_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_FactoringC)//ininoles boletas aguas
		{
			sql = "SELECT FactoringC_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else if (AcctType == ACCTTYPE_ImpuestoEspecificoCombustible)//ininoles impuesto especificoPA
		{
			sql = "SELECT C_ETax_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		else
